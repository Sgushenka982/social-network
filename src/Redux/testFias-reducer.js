const REGION_CHANGE = 'autocomplete/REGION_CHANGE'
const DISTRICT_CHANGE = 'autocomplete/DISTRICT_CHANGE'
const CITY_CHANGE = 'autocomplete/CITY_CHANGE'
const SETTLEMENT_CHANGE = 'autocomplete/SETTLEMENT_CHANGE'
const VILLAGE_CHANGE = 'autocomplete/VILLAGE_CHANGE'
const STREET_CHANGE = 'autocomplete/STREET_CHANGE'
const BUILDING_CHANGE = 'autocomplete/BUILDING_CHANGE'
const APARTMENT_CHANGE = 'autocomplete/APARTMENT_CHANGE'
const SET_VALUE = 'autocomplete/SET_VALUE'
const RESET_VALUE = 'autocomplete/RESET_VALUE'
const SET_OBJECT = 'autocomplete/SET_OBJECT'
const SET_INDEX_VALUE = 'autocomplete/SET_INDEX_VALUE'
const REGION_RESET = 'autocomplete/REGION_RESET'
const DISTRICT_RESET = 'autocomplete/DISTRICT_RESET'
const CITY_RESET = 'autocomplete/CITY_RESET'
const SETTLEMENT_RESET = 'autocomplete/SETTLEMENT_RESET'
const VILLAGE_RESET = 'autocomplete/VILLAGE_RESET'
const STREET_RESET = 'autocomplete/STREET_RESET'
const BUILDING_RESET = 'autocomplete/BUILDING_RESET'
const APARTMENT_RESET = 'autocomplete/APARTMENT_RESET'
